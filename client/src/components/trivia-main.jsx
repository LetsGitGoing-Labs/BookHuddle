...
class TriviaMain extends React.Component {
  ...
  render() {
  	return (
       ...
       {this.state.viewState === 'players' && <TriviaPlayers player={this.state.player} players={this.state.players}/>} 
       {this.state.viewState === 'host' && <TriviaHost start={this.start} onHostChange={this.onHostChange} onGameChange={this.onGameChange}/>}
       {this.state.viewState === 'hostpage' && <HostPage start={this.start} onHostChange={this.onHostChange} onGameChange={this.onGameChange}/>}
      </div>
  	)
  }
